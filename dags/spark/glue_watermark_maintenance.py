...
with DAG(
    ...
    description="CDC watermark table maintenance (cleanup old records + compaction)",
    schedule="@weekly",
    ...
    retention_days = str(config["job"]["retention_days"])
    ...
    maintenance_task = SparkSubmitOperator(
        task_id="watermark_maintenance",
        name=DAG_ID,
        conn_id="spark_default",
        application="/opt/airflow/src/watermark_maintenance.py",
